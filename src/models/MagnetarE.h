...
#ifndef SLAP_MODEL_MAGNETARE_H_
#define SLAP_MODEL_MAGNETARE_H_
...
class MagnetarE : public SNModel {
/*
...
public:
    MagnetarE(shared_ptr<Cosmology> cosmology, shared_ptr<Filters>, shared_ptr<Absorption>);
